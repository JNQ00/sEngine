...
/*!
    ...
    int main() {
        ...
        Log::setOutput(std::wcout); // revenir sur la sortie standard
...
public :
    ...
    */
    static inline void setOutput(const std::wostream &) {
    }
...
#
    ...
    */
    static inline LogLine v(const std::string &tag = "") {
        return LogLine(eErrLevel_VERBOSE, tag);
    }
    ...
    */
    static inline LogLine d(const std::string &tag = "") {
        return LogLine(eErrLevel_DEBUG, tag);
    }
    ...
    */
    static inline LogLine i(const std::string &tag = "") {
        return LogLine(eErrLevel_INFO, tag);
    }
    ...
    */
    static inline LogLine w(const std::string &tag = "") {
        return LogLine(eErrLevel_WARNING, tag);
    }
    ...
    */
    static inline LogLine e(const std::string &tag = "") {
        return LogLine(eErrLevel_ERROR, tag);
    }
        ...
        public:
            ...
            */
            inline LogLine(LogLevel l, const std::string &tag)
                : m_logLevel(l), m_message(new std::ostringstream()), m_tag(tag) {
            }
